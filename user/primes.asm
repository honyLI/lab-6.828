...
int child(int p){
   ...
   a:	84aa                	mv	s1,a0
    int tmp = 0;
   c:	fc042e23          	sw	zero,-36(s0)
    int res = read(p,&tmp,sizeof(tmp));
  10:	4611                	li	a2,4
  12:	fdc40593          	addi	a1,s0,-36
  16:	00000097          	auipc	ra,0x0
  1a:	3e0080e7          	jalr	992(ra) # 3f6 <read>
    if(res == 0){
  1e:	e919                	bnez	a0,34 <child+0x34>
        close(p);
  20:	8526                	mv	a0,s1
  22:	00000097          	auipc	ra,0x0
  26:	3e4080e7          	jalr	996(ra) # 406 <close>
        exit(0);
  2a:	4501                	li	a0,0
  2c:	00000097          	auipc	ra,0x0
  30:	3b2080e7          	jalr	946(ra) # 3de <exit>
    }else{
        printf("prime %d\n",tmp);
  34:	fdc42583          	lw	a1,-36(s0)
  38:	00001517          	auipc	a0,0x1
  3c:	8c050513          	addi	a0,a0,-1856 # 8f8 <malloc+0xe4>
  ...
  50:	3a2080e7          	jalr	930(ra) # 3ee <pipe>
    int pid = fork();
  54:	00000097          	auipc	ra,0x0
  58:	382080e7          	jalr	898(ra) # 3d6 <fork>
    if(pid == 0){
  5c:	ed09                	bnez	a0,76 <child+0x76>
        close(pi[1]);
  5e:	fd442503          	lw	a0,-44(s0)
  62:	00000097          	auipc	ra,0x0
  66:	3a4080e7          	jalr	932(ra) # 406 <close>
        child(pi[0]);
  6a:	fd042503          	lw	a0,-48(s0)
  6e:	00000097          	auipc	ra,0x0
  72:	f92080e7          	jalr	-110(ra) # 0 <child>
    }else{
        close(pi[0]);
  76:	fd042503          	lw	a0,-48(s0)
  7a:	00000097          	auipc	ra,0x0
  7e:	38c080e7          	jalr	908(ra) # 406 <close>
        int i;
  ...
  8e:	36c080e7          	jalr	876(ra) # 3f6 <read>
  92:	c115                	beqz	a0,b6 <child+0xb6>
            if(i % tmp == 0){
  94:	fcc42783          	lw	a5,-52(s0)
  98:	fdc42703          	lw	a4,-36(s0)
  9c:	02e7e7bb          	remw	a5,a5,a4
  a0:	d3ed                	beqz	a5,82 <child+0x82>
                //printf("%d:%d\n",getpid(),i);
                continue;
            }else{
  ...
  b0:	352080e7          	jalr	850(ra) # 3fe <write>
  b4:	b7f9                	j	82 <child+0x82>
            }
        }        
        close(pi[1]);
  b6:	fd442503          	lw	a0,-44(s0)
  ba:	00000097          	auipc	ra,0x0
  be:	34c080e7          	jalr	844(ra) # 406 <close>
        wait(0);        
  c2:	4501                	li	a0,0
  c4:	00000097          	auipc	ra,0x0
  c8:	322080e7          	jalr	802(ra) # 3e6 <wait>

    }
    exit(0);
  cc:	4501                	li	a0,0
  ce:	00000097          	auipc	ra,0x0
  d2:	310080e7          	jalr	784(ra) # 3de <exit>
...
int main(){
  ...
  e8:	30a080e7          	jalr	778(ra) # 3ee <pipe>
    int pid = fork();
  ec:	00000097          	auipc	ra,0x0
  f0:	2ea080e7          	jalr	746(ra) # 3d6 <fork>
    if(pid == 0){
  f4:	ed09                	bnez	a0,10e <main+0x38>
        close(p[1]);
  f6:	fdc42503          	lw	a0,-36(s0)
  fa:	00000097          	auipc	ra,0x0
  fe:	30c080e7          	jalr	780(ra) # 406 <close>
        child(p[0]);
 102:	fd842503          	lw	a0,-40(s0)
 106:	00000097          	auipc	ra,0x0
 10a:	efa080e7          	jalr	-262(ra) # 0 <child>
    }else{
        close(p[0]);
 10e:	fd842503          	lw	a0,-40(s0)
 112:	00000097          	auipc	ra,0x0
 116:	2f4080e7          	jalr	756(ra) # 406 <close>
        for(int i=2;i<=35;i++){
 11a:	4789                	li	a5,2
 ...
 132:	2d0080e7          	jalr	720(ra) # 3fe <write>
        for(int i=2;i<=35;i++){
 136:	fd442783          	lw	a5,-44(s0)
 13a:	2785                	addiw	a5,a5,1
 13c:	0007871b          	sext.w	a4,a5
 140:	fcf42a23          	sw	a5,-44(s0)
 144:	fee4d0e3          	bge	s1,a4,124 <main+0x4e>
        }
        close(p[1]);
 148:	fdc42503          	lw	a0,-36(s0)
 14c:	00000097          	auipc	ra,0x0
 150:	2ba080e7          	jalr	698(ra) # 406 <close>
        wait(0);
 154:	4501                	li	a0,0
 156:	00000097          	auipc	ra,0x0
 15a:	290080e7          	jalr	656(ra) # 3e6 <wait>
    }
    exit(0);
 15e:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c6:	44e50513          	addi	a0,a0,1102 # 910 <digits>
 4ca:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 592:	382b8b93          	addi	s7,s7,898 # 910 <digits>
 ...
 6d2:	23a90913          	addi	s2,s2,570 # 908 <malloc+0xf4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 79a:	1927b783          	ld	a5,402(a5) # 928 <freep>
 ...
 7c8:	00e6ea63          	bltu	a3,a4,7dc <free+0x50>
{
 ...
 80a:	12f73123          	sd	a5,290(a4) # 928 <freep>
}
 80e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 83c:	0f053503          	ld	a0,240(a0) # 928 <freep>
 ...
 864:	0c890913          	addi	s2,s2,200 # 928 <freep>
  if(p == (char*)-1)
 868:	5afd                	li	s5,-1
 86a:	a88d                	j	8dc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 86c:	00000797          	auipc	a5,0x0
 870:	0c478793          	addi	a5,a5,196 # 930 <base>
 874:	00000717          	auipc	a4,0x0
 878:	0af73a23          	sd	a5,180(a4) # 928 <freep>
 87c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 89e:	08a73723          	sd	a0,142(a4) # 928 <freep>
      return (void*)(p + 1);
