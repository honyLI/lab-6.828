...
int main( int argc ,char *argv[])  //通过argc和argv传入参数
{
  ...
  30:	57010413          	addi	s0,sp,1392
    int pid;
    char *argv_c[MAXARG];

    for(int i=1;i<argc;i++){
  34:	4785                	li	a5,1
  36:	02a7d463          	bge	a5,a0,5e <main+0x5e>
  3a:	00858713          	addi	a4,a1,8
  3e:	ea040793          	addi	a5,s0,-352
  42:	ffe5061b          	addiw	a2,a0,-2
  46:	1602                	slli	a2,a2,0x20
  48:	9201                	srli	a2,a2,0x20
  4a:	060e                	slli	a2,a2,0x3
  4c:	ea840693          	addi	a3,s0,-344
  ...
  62:	4a81                	li	s5,0
        while(1){
            ...
            if(c == ' ' || c == '\n'){
  64:	02000b13          	li	s6,32
  68:	4ba9                	li	s7,10
  6a:	a9840913          	addi	s2,s0,-1384
        arg_n = argc - 1;
  6e:	8a62                	mv	s4,s8
  70:	84d6                	mv	s1,s5
        int begin = 0;
  72:	89d6                	mv	s3,s5
  74:	a809                	j	86 <main+0x86>
                exit(0);
  ...
  7a:	31e080e7          	jalr	798(ra) # 394 <exit>
                ...
                buf[buf_end++] = c;
  7e:	00f90023          	sb	a5,0(s2)
  82:	2485                	addiw	s1,s1,1
  84:	0905                	addi	s2,s2,1
  86:	00048c9b          	sext.w	s9,s1
            res = read(0,p,1);
  8a:	4605                	li	a2,1
  8c:	e9f40593          	addi	a1,s0,-353
  90:	8556                	mv	a0,s5
  92:	00000097          	auipc	ra,0x0
  96:	31a080e7          	jalr	794(ra) # 3ac <read>
            if(res == 0){
  9a:	dd71                	beqz	a0,76 <main+0x76>
            if(c == ' ' || c == '\n'){
  9c:	e9f44783          	lbu	a5,-353(s0)
  a0:	05678f63          	beq	a5,s6,fe <main+0xfe>
  a4:	fd779de3          	bne	a5,s7,7e <main+0x7e>
                buf[buf_end++] = 0; 
  a8:	fa040793          	addi	a5,s0,-96
  ac:	9cbe                	add	s9,s9,a5
  ae:	ae0c8c23          	sb	zero,-1288(s9)
                argv_c[arg_n++] = &buf[begin];
  b2:	003a1793          	slli	a5,s4,0x3
  b6:	fa040713          	addi	a4,s0,-96
  ba:	97ba                	add	a5,a5,a4
  bc:	a9840713          	addi	a4,s0,-1384
  c0:	99ba                	add	s3,s3,a4
  c2:	f137b023          	sd	s3,-256(a5)
        ...
        //printf("123456\n");
        argv_c[arg_n] = 0;
  c6:	001a079b          	addiw	a5,s4,1
  ca:	078e                	slli	a5,a5,0x3
  cc:	fa040713          	addi	a4,s0,-96
  d0:	97ba                	add	a5,a5,a4
  d2:	f007b023          	sd	zero,-256(a5)
        pid = fork();
  d6:	00000097          	auipc	ra,0x0
  da:	2b6080e7          	jalr	694(ra) # 38c <fork>
        if(pid == 0){
  de:	c519                	beqz	a0,ec <main+0xec>
            exec(argv_c[0], argv_c);//exec
        }else{
            wait(0);
  e0:	8556                	mv	a0,s5
  e2:	00000097          	auipc	ra,0x0
  e6:	2ba080e7          	jalr	698(ra) # 39c <wait>
    while(res){
  ea:	b741                	j	6a <main+0x6a>
            exec(argv_c[0], argv_c);//exec
  ec:	ea040593          	addi	a1,s0,-352
  f0:	ea043503          	ld	a0,-352(s0)
  f4:	00000097          	auipc	ra,0x0
  f8:	2d8080e7          	jalr	728(ra) # 3cc <exec>
  fc:	b7bd                	j	6a <main+0x6a>
                buf[buf_end++] = 0; 
  fe:	00090023          	sb	zero,0(s2)
                argv_c[arg_n++] = &buf[begin];
 102:	003a1793          	slli	a5,s4,0x3
 106:	fa040713          	addi	a4,s0,-96
 10a:	97ba                	add	a5,a5,a4
 10c:	a9840713          	addi	a4,s0,-1384
 110:	99ba                	add	s3,s3,a4
 112:	f137b023          	sd	s3,-256(a5)
                buf[buf_end++] = 0; 
 116:	0014899b          	addiw	s3,s1,1
                argv_c[arg_n++] = &buf[begin];
 11a:	2a05                	addiw	s4,s4,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47c:	44050513          	addi	a0,a0,1088 # 8b8 <digits>
 480:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 548:	374b8b93          	addi	s7,s7,884 # 8b8 <digits>
 ...
 688:	22c90913          	addi	s2,s2,556 # 8b0 <malloc+0xe6>
        while(*s != 0){
...
free(void *ap)
{
 ...
 750:	1847b783          	ld	a5,388(a5) # 8d0 <freep>
 ...
 77e:	00e6ea63          	bltu	a3,a4,792 <free+0x50>
{
 ...
 7c0:	10f73a23          	sd	a5,276(a4) # 8d0 <freep>
}
 7c4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f2:	0e253503          	ld	a0,226(a0) # 8d0 <freep>
 ...
 81a:	0ba90913          	addi	s2,s2,186 # 8d0 <freep>
  if(p == (char*)-1)
 81e:	5afd                	li	s5,-1
 820:	a88d                	j	892 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 822:	00000797          	auipc	a5,0x0
 826:	0b678793          	addi	a5,a5,182 # 8d8 <base>
 82a:	00000717          	auipc	a4,0x0
 82e:	0af73323          	sd	a5,166(a4) # 8d0 <freep>
 832:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 854:	08a73023          	sd	a0,128(a4) # 8d0 <freep>
      return (void*)(p + 1);
